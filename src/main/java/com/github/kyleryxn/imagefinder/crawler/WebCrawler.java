...
public class WebCrawler {
    ...
    /**
     * Gets the sitemap generated by the web crawler.
     *
     * @return the sitemap as a {@link ConcurrentMap} of URLs and their associated links.
     */
    public ConcurrentMap<String, Set<String>> getSitemap() {
        return sitemap;
    }
    ...
    public ConcurrentMap<String, Set<Image>> crawl() {
        ...
        // Create a JSON record of all images crawled
